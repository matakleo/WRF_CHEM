...
turb_names=['MYJ_SMAG_SMAG','YSU_SMAG_SMAG']
...
def plot_func(real_data,sim_data):
    temp_real=[]
    temp_sim=[]
    temp_real.append(Extract_the_shit2(real_data,temp_real,'WSPD'))

    temp_sim.append(Extract_by_name(sim_data,temp_sim,'WSPD'))
    temp_sim=temp_sim[4:28]
...
plt.legend()
plt.show()
    # print(turb+' error is ',np.mean(error_temp))
